...
def main():
    ...
    pfx_file = r'C:\Projects\nest-vesalius-m\ref\islandhospital_com-2024\wildcard.islandhospital.com_2024.pfx'  # Adjust to your actual pfx file location
    pfx_password = '1234'  # Adjust to your PFX password
